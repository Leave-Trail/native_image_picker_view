        ...
        holder.albumFrame.setOnClickListener {
            when (currentFragment) {
                is PhotosFragment -> {
                    ...
                    (currentFragment as PhotosFragment).imageGrid.adapter = MediaGridAdapter((currentFragment as PhotosFragment).photoList, malbumList[holder.adapterPosition].id)
                ...
                is VideosFragment -> {
                    ...
                    (currentFragment as VideosFragment).imageGrid.adapter = MediaGridAdapter((currentFragment as VideosFragment).photoList, malbumList[holder.adapterPosition].id)
