...
import com.leavetrail.native_image_picker_view.R
...
import com.picker.gallery.presenter.MediaPresenterImpl
...
import com.picker.gallery.view.adapters.MediaGridAdapter
import kotlinx.android.synthetic.main.fragment_media.*
import org.jetbrains.anko.doAsync
import java.io.File
import java.util.*

class VideosFragment : Fragment(), ImagePickerContract,ContextHolder {

    override var photoList: ArrayList<GalleryData> = ArrayList()
    var albumList: ArrayList<GalleryAlbums> = ArrayList()
    lateinit var glm: GridLayoutManager
    var photoids: ArrayList<Int> = ArrayList()
    val imagePickerPresenter: MediaPresenter = MediaPresenterImpl(this,"VIDEO")
    override lateinit var listener: OnPhoneImagesObtained
    ...
    fun initGalleryViews() {
        ...
        if (bundle != null) photoids = if (bundle.containsKey("photoids")) bundle.getIntegerArrayList("photoids") as ArrayList<Int> else ArrayList()
        galleryOperation()
    }
    ...
    override fun initRecyclerViews() {
        ...
        imageGrid.adapter = MediaGridAdapter(imageList = photoList, threshold = THRESHOLD)
    }
